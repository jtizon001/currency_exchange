...
// _________________________ content box: Graphs _______________________________________________________
  ...
  $( document.getElementById('go-2') ).click(function() {
    ...
    $( document.getElementsByClassName('content-box-area') ).append( "<div class = 'content-box'>Enter a base currency and a target currency to compare:<br><form enctype='application/json' id='graphForm'> <input type='text' placeholder ='Base' name='baseCurr' id ='baseCurr'> <input type='text' placeholder ='Target' name='targetCurr' id='targetCurr t1'> <select id='timeDropdown'><option value='' disabled selected>Past...</option><option value='past30Days'>Past 30 Days</option><option value='past12Months'>Past 12 Months</option></select> <input class='btn btn-primary btn-lg' type='submit' name='submit' id = 'graphButton'></form> </div>");
